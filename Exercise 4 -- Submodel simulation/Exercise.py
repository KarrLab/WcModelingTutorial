...
def simulate(model):
    ...
    #<calculate net transcription reaction>     
    #<calculate net translation reaction>
    #<calculate net RNA degradation reaction>
    ...
    for iTime in range(1, nTimeSteps):
        ...
        #<Synchronize state: submodel.updateGlobalCellState(model)>

        #<Update species counts with net translation, transcription, RNA degradation>
        #<Synchronize state: submodel.updateLocalCellState(model)>
